...
class ExpanderSimpleMLPNet(nn.Module):
    def __init__(self, net_params):
        ...
        self.feat_mlp = ExpanderMultiLinearLayer(n_mlp_layers, input_features, hidden_features, output_features,
                                             self.sparsity, activation=None, batchnorm=self.batchnorm)
