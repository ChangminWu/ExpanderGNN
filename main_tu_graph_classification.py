...
from utils import DotDict, expander_writer, expander_weights_writer,\
                  check_tensorboard, get_model_param, init_expander
...
def main():       
    ...
    if args.activation is not None:
        net_params['activation'] = args.activation #"relu" if args.activation == "relu" else None
