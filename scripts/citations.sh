...
config_file=configs/citation_node_classification/GCN_citation_100k.json
python $script --dataset ogbn-arxiv --out_dir $savedir --experiment "regular" --model "GCN" --epochs 1000 --init_lr 0.005 --linear_type "regular" --config "$config_file" --mlp_layers 1 --use_gpu $use_gpu --batch_norm True ---dropout 0.5